...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b9679337791f435b373155fde91180e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Command"; "Element"; "Remote"; "Driver"];
                      lib_pack = true;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "webdriver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "\006\001!zIà\004\131S·ÿ­\142\028\129/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
